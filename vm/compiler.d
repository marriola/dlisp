...
class CodeEmitterVisitor : LispVisitor {
    ...
    this (int nextConstant, ConstantPair[string] constants, Value form, CompiledFunction dummy = null) {
...
BytecodeFunction compile (Value form, CompiledFunction dummy = null) {
    ...
    CodeEmitterVisitor codeEmitterVisitor = new CodeEmitterVisitor(constantsVisitor.nextConstant, constantPairs, form, dummy);
